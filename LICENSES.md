...
|---|---|---|---|
| This recipe: docs, `patches/`, `scripts/`, `systemd/`, `audit/`, `tests/`, `results/` | this repository | **Apache-2.0** ([LICENSE](LICENSE)) | Use, modify, redistribute, commercially. Keep the notice. A credit or link back is appreciated but not required. |
